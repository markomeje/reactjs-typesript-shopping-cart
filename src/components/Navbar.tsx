    ...
    return (
        <NavbarBootstrap sticky="top" className="bg-white shadow-sm mb-4 py-4">
            <Container>
                ...
                { cartQuantity > 0 && (
                        <Button onClick={openCart} style={{ width: '36px', height: '36px' }} className="rounded-circle position-relative text-center" variant="outline-primary">
                        ...
                        <div className="rounded-circle d-flex justify-content-center position-absolute align=items-center bg-danger" style={{ width: '18px', height: '18px', lineHeight: '18px', top: '-5px', left: '-5px' }}>
